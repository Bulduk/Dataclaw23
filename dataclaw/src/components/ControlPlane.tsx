...
export default function ControlPlane({ auditData }: { auditData?: any }) {
  ...
  return (
    <div className="flex-1 flex flex-col h-full bg-[#050505] relative z-10">
      ...
      <div className="flex-1 overflow-hidden flex flex-col sm:flex-row gap-6 p-6">
        
        {/* Chat Area */}
        <div className="flex-1 flex flex-col bg-white/5 border border-white/10 rounded-xl overflow-hidden relative">
          ...
          <div className="flex-1 overflow-y-auto p-6 flex flex-col gap-4 relative z-10" ref={chatRef}>
            {messages.map((m) => (
